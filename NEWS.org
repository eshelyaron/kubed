...
This is a bugfix release, it fixes a regression in version 0.7.0
that caused reverting resource YAML buffers to fail in Emacs 29/30.
...
along with one larger new feature:
